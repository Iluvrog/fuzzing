...
# create_command(nb = 10, dharma_grammar = "dharma_grammars/ftp_grammar.dg")
# Va créer la commande utilisé pour générer des mots via dharma
# Entrées :
## nb : le nombre de mots généré, 10 par défaut
## dharma_grammar : le fichier de grammaire de dharma, par défaut dharma_grammars/ftp_grammar.dg
# Sortie :
...
# generate_dharma(nb = 10, dharma_grammar = "dharma_grammars/ftp_grammar.dg")
